...
const features = [
  ...
  },
  {
    ...
    description:
      "Lineup optimization, trade evaluation, bet analysis, and weekly AI-generated commissioner digests — all powered by AI that considers matchups, weather, and trends.",
