...
const features = [
  ...
  },
  {
    ...
    description:
      "Lineup optimization, trade evaluation, bet analysis, weekly AI-generated commissioner digests, an AI Trade Review Assistant, and a League Health Dashboard — all powered by AI that considers matchups, weather, and trends.",
